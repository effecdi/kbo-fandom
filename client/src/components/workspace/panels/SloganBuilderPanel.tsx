  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        <p className="text-[11px] text-white/40 px-1">사이즈 프리셋</p>
        <div className="grid grid-cols-2 gap-1.5">
          {SLOGAN_SIZES.map((size) => (
            ...
            >
              <p className="text-[11px] font-semibold">{size.label}</p>
              <p className="text-[10px] text-white/30">{size.desc}</p>
            </button>
          ))}
        </div>
      </div>
      ...
      {/* Text Templates */}
      <div className="space-y-1.5">
        <p className="text-[11px] text-white/40 px-1">응원 문구 템플릿</p>
      ...
      <div className="rounded-xl bg-amber-500/5 border border-amber-500/10 p-3 space-y-1">
        <div className="flex items-center gap-1.5">
          ...
          <p className="text-[11px] font-semibold text-amber-400">가독성 가이드</p>
        </div>
