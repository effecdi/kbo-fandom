...
import {
  ...
  Wand2, MessageCircle, Target, Eye, ChevronDown, FileText, Paintbrush, Briefcase, MessageSquare, Trees, BookOpen, FolderOpen, HelpCircle,
} from "lucide-react";
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Badge variant="secondary" data-testid="badge-credits" className="gap-1 bg-primary/10 text-primary border-primary/20 cursor-pointer">
                  ...
                  {credits.tier === "pro" ? "200 credits" : `${(credits.credits ?? 0) + (credits.dailyBonusCredits ?? 0)} credits`}
