...
export function HeroSection() {
  return (
    <section className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 flex items-center justify-center px-4 py-20">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl p-8 lg:p-12 overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-gray-50 to-gray-100 opacity-50" />
            <div className="relative z-10">
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-6 border-4 border-dashed border-gray-300">
                <img
