          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <p className="text-[15px] font-semibold text-foreground truncate">{entry.nickname}</p>
                {entry.badge && (
                  <span className={`text-[13px] px-1.5 py-0.5 rounded-full text-white font-bold ${
            ...
            <div className="text-right shrink-0">
              ...
              <p className="text-[13px] text-muted-foreground/60">점수</p>
            </div>
          </div>
        );
      })}
