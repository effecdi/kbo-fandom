...
const FAQ_ITEMS = [
  ...
  {
    id: "signup",
    title: "가입 축하 선물: 50 크레딧 즉시 지급",
    content:
      "올리에 가입하시면 즉시 50 크레딧이 지급됩니다. 캐릭터 생성, 포즈/배경 생성, 스토리 스크립트 등 다양한 기능에 자유롭게 사용해보세요!",
  },
  {
    id: "monthly",
    title: "매월 정기 지원: 매월 1일 30 크레딧 충전",
    content:
      "매월 1일에 무료 사용자에게 30 크레딧이 자동 충전됩니다. 별도의 신청 없이 매달 꾸준히 크레딧을 받을 수 있어요.",
  },
  {
    id: "daily",
    title: "매일매일 출석 보너스: 매일 10 크레딧",
    content:
      "매일 올리에 접속하면 10 크레딧이 보너스로 지급됩니다. 출석 보너스 크레딧은 해당일 자정(KST)에 만료되며, 사용 시 보너스 크레딧이 먼저 차감됩니다.",
  },
  {
    id: "tips",
    title: "수석 기획자의 꿀팁",
