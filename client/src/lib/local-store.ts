...
export function seedIfEmpty(): void {
  ...
  if (listItems(STORE_KEYS.KBO_TEAMS).length === 0) {
    const teams: KboTeam[] = [
      ...
      { id: "team-doo", name: "Doosan Bears", nameKo: "두산 베어스", city: "서울", stadium: "잠실야구장", fandomName: "베어스 팬", foundedYear: 1982, followers: 0, fanartCount: 0, coverColor: "#131230", secondaryColor: "#ED1C24", description: "잠실의 전통 강호, 2025 RARE Design 리브랜딩", mascot: "Cheol-woong", logoUrl: "https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/emblem/regular/fixed/emblem_OB.png" },
      ...
      { id: "team-lot", name: "Lotte Giants", nameKo: "롯데 자이언츠", city: "부산", stadium: "사직야구장", fandomName: "자이언츠 팬", foundedYear: 1982, followers: 0, fanartCount: 0, coverColor: "#041E42", secondaryColor: "#E30613", description: "부산의 영웅, 2023 갈매기 CI 리뉴얼", mascot: "Giant", logoUrl: "https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/emblem/regular/fixed/emblem_LT.png" },
      ...
      { id: "team-han", name: "Hanwha Eagles", nameKo: "한화 이글스", city: "대전", stadium: "한화생명볼파크", fandomName: "이글스 팬", foundedYear: 1986, followers: 0, fanartCount: 0, coverColor: "#FF6600", secondaryColor: "#1B2A4A", description: "대전의 독수리, 2025 새 BI 'RIDE THE STORM'", mascot: "Suri", logoUrl: "https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/emblem/regular/fixed/emblem_HH.png" },
