...
export function seedIfEmpty(): void {
  ...
  if (listItems(STORE_KEYS.KBO_PLAYERS).length === 0) {
    const players: KboPlayer[] = [
      ...
      { id: "plr-lg-7", groupId: "team-lg", name: "오스틴", nameKo: "오스틴", position: "내야수", jerseyNumber: 30, color: "#C60C30", role: "3번타자" },
      { id: "plr-lg-8", groupId: "team-lg", name: "치리노스", nameKo: "치리노스", position: "투수", jerseyNumber: 46, color: "#C60C30", role: "선발" },
      { id: "plr-lg-9", groupId: "team-lg", name: "톨허스트", nameKo: "톨허스트", position: "투수", jerseyNumber: 35, color: "#C60C30", role: "선발" },
      { id: "plr-lg-10", groupId: "team-lg", name: "이우찬", nameKo: "이우찬", position: "투수", jerseyNumber: 19, color: "#C60C30", role: "마감" },
      { id: "plr-lg-11", groupId: "team-lg", name: "유영찬", nameKo: "유영찬", position: "투수", jerseyNumber: 33, color: "#C60C30", role: "선발" },
      { id: "plr-lg-12", groupId: "team-lg", name: "구본혁", nameKo: "구본혁", position: "내야수", jerseyNumber: 6, color: "#C60C30", role: "유망주" },
      { id: "plr-lg-13", groupId: "team-lg", name: "문성주", nameKo: "문성주", position: "외야수", jerseyNumber: 25, color: "#C60C30", role: "주전" },
      { id: "plr-lg-14", groupId: "team-lg", name: "배재준", nameKo: "배재준", position: "투수", jerseyNumber: 41, color: "#C60C30", role: "셋업" },
      { id: "plr-lg-15", groupId: "team-lg", name: "최원영", nameKo: "최원영", position: "외야수", jerseyNumber: 55, color: "#C60C30", role: "핵심" },
      // ── KT Wiz ──
      ...
      { id: "plr-kt-3", groupId: "team-kt", name: "김현수", nameKo: "김현수", position: "외야수", jerseyNumber: 23, color: "#ED1C24", role: "핵심" },
      ...
      { id: "plr-kt-6", groupId: "team-kt", name: "힐리어드", nameKo: "힐리어드", position: "내야수", jerseyNumber: 50, color: "#ED1C24", role: "3번타자" },
      { id: "plr-kt-7", groupId: "team-kt", name: "사우어", nameKo: "사우어", position: "투수", jerseyNumber: 45, color: "#ED1C24", role: "선발" },
      { id: "plr-kt-8", groupId: "team-kt", name: "보쉬릴리", nameKo: "보쉬릴리", position: "투수", jerseyNumber: 31, color: "#ED1C24", role: "선발" },
      { id: "plr-kt-9", groupId: "team-kt", name: "허경민", nameKo: "허경민", position: "내야수", jerseyNumber: 13, color: "#ED1C24", role: "핵심" },
      { id: "plr-kt-10", groupId: "team-kt", name: "장성우", nameKo: "장성우", position: "포수", jerseyNumber: 32, color: "#ED1C24", role: "주전" },
      { id: "plr-kt-11", groupId: "team-kt", name: "오윤석", nameKo: "오윤석", position: "내야수", jerseyNumber: 2, color: "#ED1C24", role: "주전" },
      { id: "plr-kt-12", groupId: "team-kt", name: "김상수", nameKo: "김상수", position: "내야수", jerseyNumber: 3, color: "#ED1C24", role: "주전" },
      { id: "plr-kt-13", groupId: "team-kt", name: "한승혁", nameKo: "한승혁", position: "투수", jerseyNumber: 18, color: "#ED1C24", role: "선발" },
      { id: "plr-kt-14", groupId: "team-kt", name: "우규민", nameKo: "우규민", position: "투수", jerseyNumber: 11, color: "#ED1C24", role: "셋업" },
      { id: "plr-kt-15", groupId: "team-kt", name: "스기모토", nameKo: "스기모토", position: "투수", jerseyNumber: 48, color: "#ED1C24", role: "선발" },
      // ── SSG Landers ──
      { id: "plr-ssg-1", groupId: "team-ssg", name: "화이트", nameKo: "미치 화이트", position: "투수", jerseyNumber: 47, color: "#CE0E2D", role: "에이스" },
      { id: "plr-ssg-2", groupId: "team-ssg", name: "최정", nameKo: "최정", position: "내야수", jerseyNumber: 3, color: "#CE0E2D", role: "4번타자" },
      { id: "plr-ssg-3", groupId: "team-ssg", name: "김재환", nameKo: "김재환", position: "외야수", jerseyNumber: 4, color: "#CE0E2D", role: "3번타자" },
      { id: "plr-ssg-4", groupId: "team-ssg", name: "에레디아", nameKo: "에레디아", position: "외야수", jerseyNumber: 6, color: "#CE0E2D", role: "핵심" },
      { id: "plr-ssg-5", groupId: "team-ssg", name: "최지훈", nameKo: "최지훈", position: "외야수", jerseyNumber: 2, color: "#CE0E2D", role: "리드오프" },
      { id: "plr-ssg-6", groupId: "team-ssg", name: "조병현", nameKo: "조병현", position: "투수", jerseyNumber: 17, color: "#CE0E2D", role: "선발" },
      { id: "plr-ssg-7", groupId: "team-ssg", name: "베니지아노", nameKo: "베니지아노", position: "투수", jerseyNumber: 40, color: "#CE0E2D", role: "선발" },
      { id: "plr-ssg-8", groupId: "team-ssg", name: "문승원", nameKo: "문승원", position: "투수", jerseyNumber: 11, color: "#CE0E2D", role: "마감" },
      { id: "plr-ssg-9", groupId: "team-ssg", name: "조형우", nameKo: "조형우", position: "포수", jerseyNumber: 22, color: "#CE0E2D", role: "주전" },
      { id: "plr-ssg-10", groupId: "team-ssg", name: "이지영", nameKo: "이지영", position: "포수", jerseyNumber: 10, color: "#CE0E2D", role: "주전" },
      { id: "plr-ssg-11", groupId: "team-ssg", name: "박성한", nameKo: "박성한", position: "내야수", jerseyNumber: 7, color: "#CE0E2D", role: "주전" },
      { id: "plr-ssg-12", groupId: "team-ssg", name: "고명준", nameKo: "고명준", position: "내야수", jerseyNumber: 55, color: "#CE0E2D", role: "유망주" },
      { id: "plr-ssg-13", groupId: "team-ssg", name: "노경은", nameKo: "노경은", position: "투수", jerseyNumber: 28, color: "#CE0E2D", role: "선발" },
      { id: "plr-ssg-14", groupId: "team-ssg", name: "김민", nameKo: "김민", position: "투수", jerseyNumber: 15, color: "#CE0E2D", role: "셋업" },
      { id: "plr-ssg-15", groupId: "team-ssg", name: "채현우", nameKo: "채현우", position: "외야수", jerseyNumber: 51, color: "#CE0E2D", role: "주전" },
      // ── NC Dinos ──
      ...
      { id: "plr-nc-5", groupId: "team-nc", name: "테일러", nameKo: "커티스 테일러", position: "투수", jerseyNumber: 43, color: "#315288", role: "선발" },
      { id: "plr-nc-6", groupId: "team-nc", name: "데이비슨", nameKo: "맷 데이비슨", position: "내야수", jerseyNumber: 40, color: "#315288", role: "3번타자" },
      { id: "plr-nc-7", groupId: "team-nc", name: "토다", nameKo: "토다", position: "투수", jerseyNumber: 50, color: "#315288", role: "선발" },
      { id: "plr-nc-8", groupId: "team-nc", name: "박민우", nameKo: "박민우", position: "내야수", jerseyNumber: 1, color: "#315288", role: "주전" },
      { id: "plr-nc-9", groupId: "team-nc", name: "김주원", nameKo: "김주원", position: "내야수", jerseyNumber: 6, color: "#315288", role: "주전" },
      { id: "plr-nc-10", groupId: "team-nc", name: "김형준", nameKo: "김형준", position: "포수", jerseyNumber: 15, color: "#315288", role: "주전" },
      { id: "plr-nc-11", groupId: "team-nc", name: "류진욱", nameKo: "류진욱", position: "투수", jerseyNumber: 33, color: "#315288", role: "선발" },
      { id: "plr-nc-12", groupId: "team-nc", name: "임정호", nameKo: "임정호", position: "투수", jerseyNumber: 46, color: "#315288", role: "셋업" },
      { id: "plr-nc-13", groupId: "team-nc", name: "천재환", nameKo: "천재환", position: "외야수", jerseyNumber: 9, color: "#315288", role: "주전" },
      { id: "plr-nc-14", groupId: "team-nc", name: "신재인", nameKo: "신재인", position: "내야수", jerseyNumber: 2, color: "#315288", role: "유망주" },
      { id: "plr-nc-15", groupId: "team-nc", name: "한석현", nameKo: "한석현", position: "외야수", jerseyNumber: 25, color: "#315288", role: "주전" },
      // ── Doosan Bears ──
      ...
      { id: "plr-doo-5", groupId: "team-doo", name: "플렉센", nameKo: "크리스 플렉센", position: "투수", jerseyNumber: 45, color: "#131230", role: "선발" },
      { id: "plr-doo-6", groupId: "team-doo", name: "카메론", nameKo: "다즈 카메론", position: "외야수", jerseyNumber: 50, color: "#131230", role: "4번타자" },
      { id: "plr-doo-7", groupId: "team-doo", name: "김택연", nameKo: "김택연", position: "투수", jerseyNumber: 36, color: "#131230", role: "선발" },
      { id: "plr-doo-8", groupId: "team-doo", name: "잭로그", nameKo: "잭로그", position: "투수", jerseyNumber: 31, color: "#131230", role: "선발" },
      { id: "plr-doo-9", groupId: "team-doo", name: "이용찬", nameKo: "이용찬", position: "투수", jerseyNumber: 28, color: "#131230", role: "마감" },
      { id: "plr-doo-10", groupId: "team-doo", name: "이병헌", nameKo: "이병헌", position: "투수", jerseyNumber: 17, color: "#131230", role: "셋업" },
      { id: "plr-doo-11", groupId: "team-doo", name: "양석환", nameKo: "양석환", position: "내야수", jerseyNumber: 3, color: "#131230", role: "4번타자" },
      { id: "plr-doo-12", groupId: "team-doo", name: "이유찬", nameKo: "이유찬", position: "내야수", jerseyNumber: 7, color: "#131230", role: "3번타자" },
      { id: "plr-doo-13", groupId: "team-doo", name: "조수행", nameKo: "조수행", position: "외야수", jerseyNumber: 24, color: "#131230", role: "유망주" },
      { id: "plr-doo-14", groupId: "team-doo", name: "오명진", nameKo: "오명진", position: "내야수", jerseyNumber: 13, color: "#131230", role: "주전" },
      { id: "plr-doo-15", groupId: "team-doo", name: "김인태", nameKo: "김인태", position: "외야수", jerseyNumber: 55, color: "#131230", role: "주전" },
      // ── KIA Tigers (2024 한국시리즈 우승) ──
      { id: "plr-kia-1", groupId: "team-kia", name: "네일", nameKo: "제임스 네일", position: "투수", jerseyNumber: 40, color: "#EA0029", role: "에이스" },
      ...
      { id: "plr-kia-4", groupId: "team-kia", name: "조상우", nameKo: "조상우", position: "투수", jerseyNumber: 11, color: "#EA0029", role: "마감" },
      { id: "plr-kia-5", groupId: "team-kia", name: "한준수", nameKo: "한준수", position: "포수", jerseyNumber: 25, color: "#EA0029", role: "주전" },
      { id: "plr-kia-6", groupId: "team-kia", name: "김선빈", nameKo: "김선빈", position: "내야수", jerseyNumber: 3, color: "#EA0029", role: "주전" },
      { id: "plr-kia-7", groupId: "team-kia", name: "이의리", nameKo: "이의리", position: "투수", jerseyNumber: 17, color: "#EA0029", role: "선발" },
      { id: "plr-kia-8", groupId: "team-kia", name: "올러", nameKo: "올러", position: "투수", jerseyNumber: 43, color: "#EA0029", role: "선발" },
      { id: "plr-kia-9", groupId: "team-kia", name: "정해영", nameKo: "정해영", position: "투수", jerseyNumber: 22, color: "#EA0029", role: "셋업" },
      { id: "plr-kia-10", groupId: "team-kia", name: "김태군", nameKo: "김태군", position: "포수", jerseyNumber: 10, color: "#EA0029", role: "주전" },
      { id: "plr-kia-11", groupId: "team-kia", name: "데일", nameKo: "데일", position: "내야수", jerseyNumber: 44, color: "#EA0029", role: "핵심" },
      { id: "plr-kia-12", groupId: "team-kia", name: "카스트로", nameKo: "카스트로", position: "외야수", jerseyNumber: 30, color: "#EA0029", role: "핵심" },
      { id: "plr-kia-13", groupId: "team-kia", name: "변우혁", nameKo: "변우혁", position: "내야수", jerseyNumber: 6, color: "#EA0029", role: "유망주" },
      { id: "plr-kia-14", groupId: "team-kia", name: "이창진", nameKo: "이창진", position: "외야수", jerseyNumber: 15, color: "#EA0029", role: "주전" },
      { id: "plr-kia-15", groupId: "team-kia", name: "김호령", nameKo: "김호령", position: "외야수", jerseyNumber: 55, color: "#EA0029", role: "주전" },
      // ── Lotte Giants ──
      { id: "plr-lot-1", groupId: "team-lot", name: "전준우", nameKo: "전준우", position: "외야수", jerseyNumber: 8, color: "#041E42", role: "4번타자" },
      { id: "plr-lot-2", groupId: "team-lot", name: "한태양", nameKo: "한태양", position: "내야수", jerseyNumber: 6, color: "#041E42", role: "주전" },
      { id: "plr-lot-3", groupId: "team-lot", name: "박세웅", nameKo: "박세웅", position: "투수", jerseyNumber: 11, color: "#041E42", role: "에이스" },
      { id: "plr-lot-4", groupId: "team-lot", name: "레이예스", nameKo: "빅터 레이예스", position: "외야수", jerseyNumber: 29, color: "#041E42", role: "3번타자" },
      { id: "plr-lot-5", groupId: "team-lot", name: "로드리게스", nameKo: "엘빈 로드리게스", position: "투수", jerseyNumber: 40, color: "#041E42", role: "선발" },
      { id: "plr-lot-6", groupId: "team-lot", name: "비슬리", nameKo: "제레미 비슬리", position: "투수", jerseyNumber: 45, color: "#041E42", role: "선발" },
      { id: "plr-lot-7", groupId: "team-lot", name: "김원중", nameKo: "김원중", position: "투수", jerseyNumber: 50, color: "#041E42", role: "마감" },
      { id: "plr-lot-8", groupId: "team-lot", name: "쿄야마", nameKo: "쿄야마", position: "투수", jerseyNumber: 46, color: "#041E42", role: "선발" },
      { id: "plr-lot-9", groupId: "team-lot", name: "정철원", nameKo: "정철원", position: "투수", jerseyNumber: 57, color: "#041E42", role: "셋업" },
      { id: "plr-lot-10", groupId: "team-lot", name: "유강남", nameKo: "유강남", position: "포수", jerseyNumber: 22, color: "#041E42", role: "주전" },
      { id: "plr-lot-11", groupId: "team-lot", name: "윤동희", nameKo: "윤동희", position: "외야수", jerseyNumber: 1, color: "#041E42", role: "리드오프" },
      { id: "plr-lot-12", groupId: "team-lot", name: "황성빈", nameKo: "황성빈", position: "외야수", jerseyNumber: 2, color: "#041E42", role: "유망주" },
      { id: "plr-lot-13", groupId: "team-lot", name: "노진혁", nameKo: "노진혁", position: "내야수", jerseyNumber: 3, color: "#041E42", role: "주전" },
      { id: "plr-lot-14", groupId: "team-lot", name: "신윤후", nameKo: "신윤후", position: "외야수", jerseyNumber: 55, color: "#041E42", role: "핵심" },
      { id: "plr-lot-15", groupId: "team-lot", name: "김민성", nameKo: "김민성", position: "내야수", jerseyNumber: 7, color: "#041E42", role: "주전" },
      // ── Samsung Lions ──
      { id: "plr-sam-1", groupId: "team-sam", name: "구자욱", nameKo: "구자욱", position: "외야수", jerseyNumber: 51, color: "#074CA1", role: "핵심" },
      { id: "plr-sam-2", groupId: "team-sam", name: "후라도", nameKo: "후라도", position: "투수", jerseyNumber: 43, color: "#074CA1", role: "에이스" },
      { id: "plr-sam-3", groupId: "team-sam", name: "최원태", nameKo: "최원태", position: "투수", jerseyNumber: 11, color: "#074CA1", role: "마감" },
      { id: "plr-sam-4", groupId: "team-sam", name: "김영웅", nameKo: "김영웅", position: "내야수", jerseyNumber: 38, color: "#074CA1", role: "4번타자" },
      { id: "plr-sam-5", groupId: "team-sam", name: "최형우", nameKo: "최형우", position: "외야수", jerseyNumber: 34, color: "#074CA1", role: "핵심" },
      { id: "plr-sam-6", groupId: "team-sam", name: "디아즈", nameKo: "르윈 디아즈", position: "내야수", jerseyNumber: 3, color: "#074CA1", role: "3번타자" },
      { id: "plr-sam-7", groupId: "team-sam", name: "강민호", nameKo: "강민호", position: "포수", jerseyNumber: 15, color: "#074CA1", role: "주전" },
      { id: "plr-sam-8", groupId: "team-sam", name: "미야지", nameKo: "미야지", position: "투수", jerseyNumber: 47, color: "#074CA1", role: "선발" },
      { id: "plr-sam-9", groupId: "team-sam", name: "오러클린", nameKo: "오러클린", position: "투수", jerseyNumber: 55, color: "#074CA1", role: "선발" },
      { id: "plr-sam-10", groupId: "team-sam", name: "이승현", nameKo: "이승현", position: "투수", jerseyNumber: 18, color: "#074CA1", role: "선발" },
      { id: "plr-sam-11", groupId: "team-sam", name: "배찬승", nameKo: "배찬승", position: "투수", jerseyNumber: 28, color: "#074CA1", role: "셋업" },
      { id: "plr-sam-12", groupId: "team-sam", name: "김지찬", nameKo: "김지찬", position: "외야수", jerseyNumber: 1, color: "#074CA1", role: "리드오프" },
      { id: "plr-sam-13", groupId: "team-sam", name: "김헌곤", nameKo: "김헌곤", position: "외야수", jerseyNumber: 23, color: "#074CA1", role: "주전" },
      { id: "plr-sam-14", groupId: "team-sam", name: "류지혁", nameKo: "류지혁", position: "내야수", jerseyNumber: 7, color: "#074CA1", role: "주전" },
      { id: "plr-sam-15", groupId: "team-sam", name: "이재현", nameKo: "이재현", position: "내야수", jerseyNumber: 46, color: "#074CA1", role: "주전" },
      // ── Hanwha Eagles ──
      ...
      { id: "plr-han-3", groupId: "team-han", name: "에르난데스", nameKo: "에르난데스", position: "투수", jerseyNumber: 41, color: "#FF6600", role: "에이스" },
      { id: "plr-han-4", groupId: "team-han", name: "화이트", nameKo: "화이트", position: "투수", jerseyNumber: 47, color: "#FF6600", role: "선발" },
      ...
      { id: "plr-han-8", groupId: "team-han", name: "조동욱", nameKo: "조동욱", position: "투수", jerseyNumber: 31, color: "#FF6600", role: "선발" },
      { id: "plr-han-9", groupId: "team-han", name: "박준영", nameKo: "박준영", position: "투수", jerseyNumber: 21, color: "#FF6600", role: "선발" },
      { id: "plr-han-10", groupId: "team-han", name: "강재민", nameKo: "강재민", position: "투수", jerseyNumber: 37, color: "#FF6600", role: "마감" },
      { id: "plr-han-11", groupId: "team-han", name: "채은성", nameKo: "채은성", position: "내야수", jerseyNumber: 22, color: "#FF6600", role: "핵심" },
      { id: "plr-han-12", groupId: "team-han", name: "이도윤", nameKo: "이도윤", position: "내야수", jerseyNumber: 5, color: "#FF6600", role: "리드오프" },
      { id: "plr-han-13", groupId: "team-han", name: "이진영", nameKo: "이진영", position: "외야수", jerseyNumber: 10, color: "#FF6600", role: "주전" },
      { id: "plr-han-14", groupId: "team-han", name: "하주석", nameKo: "하주석", position: "내야수", jerseyNumber: 16, color: "#FF6600", role: "주전" },
      { id: "plr-han-15", groupId: "team-han", name: "오재원", nameKo: "오재원", position: "외야수", jerseyNumber: 9, color: "#FF6600", role: "유망주" },
      // ── Kiwoom Heroes ──
      { id: "plr-kiw-1", groupId: "team-kiw", name: "이주형", nameKo: "이주형", position: "외야수", jerseyNumber: 51, color: "#820024", role: "리드오프" },
      { id: "plr-kiw-2", groupId: "team-kiw", name: "알칸타라", nameKo: "알칸타라", position: "투수", jerseyNumber: 43, color: "#820024", role: "에이스" },
      { id: "plr-kiw-3", groupId: "team-kiw", name: "와일스", nameKo: "와일스", position: "투수", jerseyNumber: 49, color: "#820024", role: "선발" },
      { id: "plr-kiw-4", groupId: "team-kiw", name: "하영민", nameKo: "하영민", position: "투수", jerseyNumber: 19, color: "#820024", role: "선발" },
      { id: "plr-kiw-5", groupId: "team-kiw", name: "브룩스", nameKo: "트렌턴 브룩스", position: "외야수", jerseyNumber: 50, color: "#820024", role: "3번타자" },
      { id: "plr-kiw-6", groupId: "team-kiw", name: "김재웅", nameKo: "김재웅", position: "투수", jerseyNumber: 28, color: "#820024", role: "마감" },
      { id: "plr-kiw-7", groupId: "team-kiw", name: "윤석원", nameKo: "윤석원", position: "투수", jerseyNumber: 22, color: "#820024", role: "셋업" },
      { id: "plr-kiw-8", groupId: "team-kiw", name: "안치홍", nameKo: "안치홍", position: "내야수", jerseyNumber: 13, color: "#820024", role: "핵심" },
      { id: "plr-kiw-9", groupId: "team-kiw", name: "최주환", nameKo: "최주환", position: "내야수", jerseyNumber: 7, color: "#820024", role: "4번타자" },
      { id: "plr-kiw-10", groupId: "team-kiw", name: "김건희", nameKo: "김건희", position: "포수", jerseyNumber: 10, color: "#820024", role: "주전" },
      { id: "plr-kiw-11", groupId: "team-kiw", name: "추재현", nameKo: "추재현", position: "외야수", jerseyNumber: 25, color: "#820024", role: "주전" },
      { id: "plr-kiw-12", groupId: "team-kiw", name: "김태진", nameKo: "김태진", position: "내야수", jerseyNumber: 3, color: "#820024", role: "주전" },
      { id: "plr-kiw-13", groupId: "team-kiw", name: "오석주", nameKo: "오석주", position: "투수", jerseyNumber: 17, color: "#820024", role: "선발" },
      { id: "plr-kiw-14", groupId: "team-kiw", name: "이형종", nameKo: "이형종", position: "외야수", jerseyNumber: 55, color: "#820024", role: "주전" },
      { id: "plr-kiw-15", groupId: "team-kiw", name: "오선진", nameKo: "오선진", position: "내야수", jerseyNumber: 6, color: "#820024", role: "유망주" },
    ];
