...
const SEED_VERSION = 22; // v22: 전 선수 throws/bats(투타) 데이터 추가 (10구단 ~150명)
...
export function seedIfEmpty(): void {
  ...
  if (listItems(STORE_KEYS.KBO_PLAYERS).length === 0) {
    const players: KboPlayer[] = [
      ...
      { id: "plr-lg-4", groupId: "team-lg", name: "임찬규", nameKo: "임찬규", position: "투수", jerseyNumber: 1, color: "#C60C30", role: "에이스", pcode: "61101", throws: "좌", bats: "좌" },
      { id: "plr-lg-5", groupId: "team-lg", name: "문보경", nameKo: "문보경", position: "내야수", jerseyNumber: 2, color: "#C60C30", role: "4번타자", pcode: "69102", throws: "우", bats: "우" },
      ...
      { id: "plr-lg-15", groupId: "team-lg", name: "최원영", nameKo: "최원영", position: "외야수", jerseyNumber: 55, color: "#C60C30", role: "핵심", pcode: "52103", throws: "우", bats: "좌" },
      // ── KT Wiz ──
      ...
      { id: "plr-kt-3", groupId: "team-kt", name: "김현수", nameKo: "김현수", position: "외야수", jerseyNumber: 23, color: "#ED1C24", role: "핵심", pcode: "76290", throws: "우", bats: "우" },
      ...
      { id: "plr-kt-10", groupId: "team-kt", name: "장성우", nameKo: "장성우", position: "포수", jerseyNumber: 32, color: "#ED1C24", role: "주전", pcode: "78548", throws: "우", bats: "우" },
      { id: "plr-kt-11", groupId: "team-kt", name: "오윤석", nameKo: "오윤석", position: "내야수", jerseyNumber: 2, color: "#ED1C24", role: "주전", pcode: "64504", throws: "우", bats: "우" },
      { id: "plr-kt-12", groupId: "team-kt", name: "김상수", nameKo: "김상수", position: "내야수", jerseyNumber: 3, color: "#ED1C24", role: "주전", pcode: "79402", throws: "우", bats: "우" },
      ...
      { id: "plr-kt-14", groupId: "team-kt", name: "우규민", nameKo: "우규민", position: "투수", jerseyNumber: 11, color: "#ED1C24", role: "셋업", pcode: "73117", throws: "우", bats: "우" },
      ...
      { id: "plr-ssg-3", groupId: "team-ssg", name: "김재환", nameKo: "김재환", position: "외야수", jerseyNumber: 4, color: "#CE0E2D", role: "3번타자", pcode: "78224", throws: "우", bats: "우" },
      ...
      { id: "plr-ssg-12", groupId: "team-ssg", name: "고명준", nameKo: "고명준", position: "내야수", jerseyNumber: 55, color: "#CE0E2D", role: "유망주", pcode: "51868", throws: "우", bats: "우" },
      ...
      { id: "plr-ssg-14", groupId: "team-ssg", name: "김민", nameKo: "김민", position: "투수", jerseyNumber: 15, color: "#CE0E2D", role: "셋업", pcode: "68043", throws: "좌", bats: "좌" },
      ...
      { id: "plr-nc-2", groupId: "team-nc", name: "토다", nameKo: "토다 나츠키", position: "투수", jerseyNumber: 11, color: "#315288", role: "선발", pcode: "56911", throws: "좌", bats: "좌" },
      { id: "plr-nc-3", groupId: "team-nc", name: "테일러", nameKo: "커티스 테일러", position: "투수", jerseyNumber: 66, color: "#315288", role: "선발", pcode: "56966", throws: "우", bats: "우" },
      { id: "plr-nc-4", groupId: "team-nc", name: "김영규", nameKo: "김영규", position: "투수", jerseyNumber: 17, color: "#315288", role: "선발", pcode: "68900", throws: "우", bats: "우" },
      { id: "plr-nc-5", groupId: "team-nc", name: "류진욱", nameKo: "류진욱", position: "투수", jerseyNumber: 41, color: "#315288", role: "선발", pcode: "65949", throws: "좌", bats: "좌" },
      { id: "plr-nc-6", groupId: "team-nc", name: "임지민", nameKo: "임지민", position: "투수", jerseyNumber: 19, color: "#315288", role: "중계", pcode: "53909", throws: "좌", bats: "좌" },
      { id: "plr-nc-7", groupId: "team-nc", name: "임정호", nameKo: "임정호", position: "투수", jerseyNumber: 30, color: "#315288", role: "셋업", pcode: "63959", throws: "우", bats: "우" },
      { id: "plr-nc-8", groupId: "team-nc", name: "이준혁", nameKo: "이준혁", position: "투수", jerseyNumber: 40, color: "#315288", role: "중계", pcode: "52992", throws: "우", bats: "우" },
      { id: "plr-nc-9", groupId: "team-nc", name: "손주환", nameKo: "손주환", position: "투수", jerseyNumber: 46, color: "#315288", role: "중계", pcode: "54904", throws: "우", bats: "우" },
      { id: "plr-nc-10", groupId: "team-nc", name: "김진호", nameKo: "김진호", position: "투수", jerseyNumber: 54, color: "#315288", role: "마감", pcode: "67954", throws: "우", bats: "우" },
      { id: "plr-nc-11", groupId: "team-nc", name: "배재환", nameKo: "배재환", position: "투수", jerseyNumber: 61, color: "#315288", role: "중계", pcode: "64995", throws: "우", bats: "우" },
      { id: "plr-nc-12", groupId: "team-nc", name: "원종해", nameKo: "원종해", position: "투수", jerseyNumber: 63, color: "#315288", role: "중계", pcode: "54906", throws: "우", bats: "우" },
      // 포수 (2명)
      { id: "plr-nc-13", groupId: "team-nc", name: "김형준", nameKo: "김형준", position: "포수", jerseyNumber: 25, color: "#315288", role: "주전", pcode: "68912", throws: "우", bats: "우" },
      { id: "plr-nc-14", groupId: "team-nc", name: "김정호", nameKo: "김정호", position: "포수", jerseyNumber: 42, color: "#315288", role: "주전", pcode: "51903", throws: "우", bats: "우" },
      // 내야수 (10명)
      { id: "plr-nc-15", groupId: "team-nc", name: "데이비슨", nameKo: "맷 데이비슨", position: "내야수", jerseyNumber: 24, color: "#315288", role: "4번타자", pcode: "54944", throws: "우", bats: "우" },
      { id: "plr-nc-16", groupId: "team-nc", name: "박민우", nameKo: "박민우", position: "내야수", jerseyNumber: 2, color: "#315288", role: "핵심", pcode: "62907", throws: "우", bats: "우" },
      { id: "plr-nc-17", groupId: "team-nc", name: "서호철", nameKo: "서호철", position: "내야수", jerseyNumber: 5, color: "#315288", role: "핵심", pcode: "69995", throws: "우", bats: "우" },
      { id: "plr-nc-18", groupId: "team-nc", name: "김주원", nameKo: "김주원", position: "내야수", jerseyNumber: 7, color: "#315288", role: "주전", pcode: "51907", throws: "우", bats: "우" },
      { id: "plr-nc-19", groupId: "team-nc", name: "허윤", nameKo: "허윤", position: "내야수", jerseyNumber: 4, color: "#315288", role: "주전", pcode: "", throws: "우", bats: "우" },
      { id: "plr-nc-20", groupId: "team-nc", name: "신재인", nameKo: "신재인", position: "내야수", jerseyNumber: 9, color: "#315288", role: "주전", pcode: "56909", throws: "우", bats: "우" },
      { id: "plr-nc-21", groupId: "team-nc", name: "김한별", nameKo: "김한별", position: "내야수", jerseyNumber: 13, color: "#315288", role: "주전", pcode: "50902", throws: "우", bats: "우" },
      { id: "plr-nc-22", groupId: "team-nc", name: "최정원", nameKo: "최정원", position: "내야수", jerseyNumber: 14, color: "#315288", role: "주전", pcode: "69992", throws: "우", bats: "우" },
      { id: "plr-nc-23", groupId: "team-nc", name: "오영수", nameKo: "오영수", position: "내야수", jerseyNumber: 34, color: "#315288", role: "주전", pcode: "68904", throws: "우", bats: "우" },
      { id: "plr-nc-24", groupId: "team-nc", name: "김휘집", nameKo: "김휘집", position: "내야수", jerseyNumber: 44, color: "#315288", role: "주전", pcode: "51344", throws: "우", bats: "좌" },
      // 외야수 (5명)
      { id: "plr-nc-25", groupId: "team-nc", name: "박건우", nameKo: "박건우", position: "외야수", jerseyNumber: 37, color: "#315288", role: "핵심", pcode: "79215", throws: "우", bats: "우" },
      { id: "plr-nc-26", groupId: "team-nc", name: "천재환", nameKo: "천재환", position: "외야수", jerseyNumber: 23, color: "#315288", role: "주전", pcode: "67905", throws: "우", bats: "우" },
      { id: "plr-nc-27", groupId: "team-nc", name: "한석현", nameKo: "한석현", position: "외야수", jerseyNumber: 33, color: "#315288", role: "주전", pcode: "64101", throws: "우", bats: "우" },
      { id: "plr-nc-28", groupId: "team-nc", name: "권희동", nameKo: "권희동", position: "외야수", jerseyNumber: 36, color: "#315288", role: "리드오프", pcode: "63963", throws: "우", bats: "우" },
      { id: "plr-nc-29", groupId: "team-nc", name: "고준휘", nameKo: "고준휘", position: "외야수", jerseyNumber: 49, color: "#315288", role: "주전", pcode: "62934", throws: "우", bats: "우" },
      // ── Doosan Bears ──
      ...
      { id: "plr-doo-3", groupId: "team-doo", name: "정수빈", nameKo: "정수빈", position: "외야수", jerseyNumber: 15, color: "#131230", role: "리드오프", pcode: "79231", throws: "우", bats: "좌" },
      ...
      { id: "plr-doo-10", groupId: "team-doo", name: "이병헌", nameKo: "이병헌", position: "투수", jerseyNumber: 17, color: "#131230", role: "셋업", pcode: "52204", throws: "우", bats: "우" },
      ...
      { id: "plr-doo-13", groupId: "team-doo", name: "조수행", nameKo: "조수행", position: "외야수", jerseyNumber: 24, color: "#131230", role: "유망주", pcode: "66209", throws: "우", bats: "우" },
      { id: "plr-doo-14", groupId: "team-doo", name: "오명진", nameKo: "오명진", position: "내야수", jerseyNumber: 13, color: "#131230", role: "주전", pcode: "50208", throws: "우", bats: "우" },
      { id: "plr-doo-15", groupId: "team-doo", name: "김인태", nameKo: "김인태", position: "외야수", jerseyNumber: 55, color: "#131230", role: "주전", pcode: "63257", throws: "우", bats: "우" },
      ...
      { id: "plr-kia-2", groupId: "team-kia", name: "조상우", nameKo: "조상우", position: "투수", jerseyNumber: 11, color: "#EA0029", role: "마감", pcode: "63342", throws: "우", bats: "우" },
      { id: "plr-kia-3", groupId: "team-kia", name: "올러", nameKo: "아담 올러", position: "투수", jerseyNumber: 33, color: "#EA0029", role: "선발", pcode: "55633", throws: "우", bats: "우" },
      { id: "plr-kia-4", groupId: "team-kia", name: "네일", nameKo: "제임스 네일", position: "투수", jerseyNumber: 40, color: "#EA0029", role: "선발", pcode: "54640", throws: "우", bats: "우" },
      { id: "plr-kia-5", groupId: "team-kia", name: "이의리", nameKo: "이의리", position: "투수", jerseyNumber: 48, color: "#EA0029", role: "선발", pcode: "51648", throws: "좌", bats: "좌" },
      { id: "plr-kia-6", groupId: "team-kia", name: "정해영", nameKo: "정해영", position: "투수", jerseyNumber: 62, color: "#EA0029", role: "셋업", pcode: "50662", throws: "우", bats: "우" },
      { id: "plr-kia-7", groupId: "team-kia", name: "황동하", nameKo: "황동하", position: "투수", jerseyNumber: 41, color: "#EA0029", role: "선발", pcode: "52641", throws: "우", bats: "우" },
      { id: "plr-kia-8", groupId: "team-kia", name: "최지민", nameKo: "최지민", position: "투수", jerseyNumber: 39, color: "#EA0029", role: "중계", pcode: "52639", throws: "좌", bats: "좌" },
      { id: "plr-kia-9", groupId: "team-kia", name: "김범수", nameKo: "김범수", position: "투수", jerseyNumber: 49, color: "#EA0029", role: "중계", pcode: "65769", throws: "우", bats: "우" },
      { id: "plr-kia-10", groupId: "team-kia", name: "전상현", nameKo: "전상현", position: "투수", jerseyNumber: 51, color: "#EA0029", role: "중계", pcode: "66609", throws: "우", bats: "우" },
      { id: "plr-kia-11", groupId: "team-kia", name: "김기훈", nameKo: "김기훈", position: "투수", jerseyNumber: 53, color: "#EA0029", role: "중계", pcode: "69620", throws: "우", bats: "우" },
      { id: "plr-kia-12", groupId: "team-kia", name: "김시훈", nameKo: "김시훈", position: "투수", jerseyNumber: 61, color: "#EA0029", role: "중계", pcode: "68928", throws: "우", bats: "우" },
      { id: "plr-kia-13", groupId: "team-kia", name: "성영탁", nameKo: "성영탁", position: "투수", jerseyNumber: 65, color: "#EA0029", role: "중계", pcode: "54610", throws: "우", bats: "우" },
      { id: "plr-kia-14", groupId: "team-kia", name: "홍민규", nameKo: "홍민규", position: "투수", jerseyNumber: 67, color: "#EA0029", role: "중계", pcode: "55267", throws: "좌", bats: "좌" },
      // 포수 (2명)
      { id: "plr-kia-15", groupId: "team-kia", name: "한준수", nameKo: "한준수", position: "포수", jerseyNumber: 25, color: "#EA0029", role: "주전", pcode: "68646", throws: "우", bats: "우" },
      { id: "plr-kia-16", groupId: "team-kia", name: "김태군", nameKo: "김태군", position: "포수", jerseyNumber: 42, color: "#EA0029", role: "주전", pcode: "78122", throws: "우", bats: "우" },
      // 내야수 (8명)
      { id: "plr-kia-17", groupId: "team-kia", name: "김도영", nameKo: "김도영", position: "내야수", jerseyNumber: 5, color: "#EA0029", role: "3번타자", pcode: "52605", throws: "우", bats: "우" },
      { id: "plr-kia-18", groupId: "team-kia", name: "김선빈", nameKo: "김선빈", position: "내야수", jerseyNumber: 3, color: "#EA0029", role: "주전", pcode: "78603", throws: "우", bats: "좌" },
      { id: "plr-kia-19", groupId: "team-kia", name: "데일", nameKo: "제로드 데일", position: "내야수", jerseyNumber: 32, color: "#EA0029", role: "핵심", pcode: "56632", throws: "우", bats: "우" },
      { id: "plr-kia-20", groupId: "team-kia", name: "박민", nameKo: "박민", position: "내야수", jerseyNumber: 2, color: "#EA0029", role: "주전", pcode: "50657", throws: "우", bats: "우" },
      { id: "plr-kia-21", groupId: "team-kia", name: "정현창", nameKo: "정현창", position: "내야수", jerseyNumber: 12, color: "#EA0029", role: "주전", pcode: "55926", throws: "우", bats: "우" },
      { id: "plr-kia-22", groupId: "team-kia", name: "김규성", nameKo: "김규성", position: "내야수", jerseyNumber: 14, color: "#EA0029", role: "주전", pcode: "66614", throws: "우", bats: "우" },
      { id: "plr-kia-23", groupId: "team-kia", name: "윤도현", nameKo: "윤도현", position: "내야수", jerseyNumber: 16, color: "#EA0029", role: "주전", pcode: "52667", throws: "우", bats: "우" },
      { id: "plr-kia-24", groupId: "team-kia", name: "오선우", nameKo: "오선우", position: "내야수", jerseyNumber: 56, color: "#EA0029", role: "주전", pcode: "69636", throws: "우", bats: "우" },
      // 외야수 (6명)
      { id: "plr-kia-25", groupId: "team-kia", name: "나성범", nameKo: "나성범", position: "외야수", jerseyNumber: 47, color: "#EA0029", role: "4번타자", pcode: "62947", throws: "우", bats: "우" },
      { id: "plr-kia-26", groupId: "team-kia", name: "카스트로", nameKo: "해롤드 카스트로", position: "외야수", jerseyNumber: 26, color: "#EA0029", role: "핵심", pcode: "56626", throws: "우", bats: "좌" },
      { id: "plr-kia-27", groupId: "team-kia", name: "이창진", nameKo: "이창진", position: "외야수", jerseyNumber: 8, color: "#EA0029", role: "주전", pcode: "64560", throws: "우", bats: "우" },
      { id: "plr-kia-28", groupId: "team-kia", name: "김호령", nameKo: "김호령", position: "외야수", jerseyNumber: 27, color: "#EA0029", role: "주전", pcode: "65653", throws: "우", bats: "우" },
      { id: "plr-kia-29", groupId: "team-kia", name: "박정우", nameKo: "박정우", position: "외야수", jerseyNumber: 1, color: "#EA0029", role: "주전", pcode: "67609", throws: "우", bats: "우" },
      { id: "plr-kia-30", groupId: "team-kia", name: "박재현", nameKo: "박재현", position: "외야수", jerseyNumber: 15, color: "#EA0029", role: "주전", pcode: "55636", throws: "우", bats: "우" },
      // ── Lotte Giants ──
      ...
      { id: "plr-lot-7", groupId: "team-lot", name: "김원중", nameKo: "김원중", position: "투수", jerseyNumber: 50, color: "#041E42", role: "마감", pcode: "62528", throws: "우", bats: "우" },
      ...
      { id: "plr-lot-11", groupId: "team-lot", name: "윤동희", nameKo: "윤동희", position: "외야수", jerseyNumber: 1, color: "#041E42", role: "리드오프", pcode: "52591", throws: "우", bats: "좌" },
      ...
      { id: "plr-lot-13", groupId: "team-lot", name: "노진혁", nameKo: "노진혁", position: "내야수", jerseyNumber: 3, color: "#041E42", role: "주전", pcode: "62931", throws: "우", bats: "우" },
      ...
      { id: "plr-sam-2", groupId: "team-sam", name: "원태인", nameKo: "원태인", position: "투수", jerseyNumber: 18, color: "#074CA1", role: "선발", pcode: "69446", throws: "우", bats: "우" },
      { id: "plr-sam-3", groupId: "team-sam", name: "최원태", nameKo: "최원태", position: "투수", jerseyNumber: 20, color: "#074CA1", role: "선발", pcode: "65320", throws: "우", bats: "우" },
      { id: "plr-sam-4", groupId: "team-sam", name: "미야지", nameKo: "미야지", position: "투수", jerseyNumber: 15, color: "#074CA1", role: "선발", pcode: "56415", throws: "우", bats: "우" },
      { id: "plr-sam-5", groupId: "team-sam", name: "배찬승", nameKo: "배찬승", position: "투수", jerseyNumber: 55, color: "#074CA1", role: "선발", pcode: "55455", throws: "우", bats: "우" },
      { id: "plr-sam-6", groupId: "team-sam", name: "오러클린", nameKo: "오러클린", position: "투수", jerseyNumber: 64, color: "#074CA1", role: "중계", pcode: "56464", throws: "우", bats: "우" },
      { id: "plr-sam-7", groupId: "team-sam", name: "이승현", nameKo: "이승현", position: "투수", jerseyNumber: 26, color: "#074CA1", role: "셋업", pcode: "51454", throws: "우", bats: "우" },
      { id: "plr-sam-8", groupId: "team-sam", name: "이승민", nameKo: "이승민", position: "투수", jerseyNumber: 28, color: "#074CA1", role: "중계", pcode: "50464", throws: "좌", bats: "좌" },
      { id: "plr-sam-9", groupId: "team-sam", name: "육선엽", nameKo: "육선엽", position: "투수", jerseyNumber: 4, color: "#074CA1", role: "중계", pcode: "54404", throws: "우", bats: "우" },
      { id: "plr-sam-10", groupId: "team-sam", name: "최지광", nameKo: "최지광", position: "투수", jerseyNumber: 11, color: "#074CA1", role: "마감", pcode: "67421", throws: "우", bats: "우" },
      { id: "plr-sam-11", groupId: "team-sam", name: "김재윤", nameKo: "김재윤", position: "투수", jerseyNumber: 62, color: "#074CA1", role: "셋업", pcode: "65062", throws: "우", bats: "우" },
      { id: "plr-sam-12", groupId: "team-sam", name: "장찬희", nameKo: "장찬희", position: "투수", jerseyNumber: 60, color: "#074CA1", role: "중계", pcode: "56460", throws: "우", bats: "우" },
      { id: "plr-sam-13", groupId: "team-sam", name: "백정현", nameKo: "백정현", position: "투수", jerseyNumber: 29, color: "#074CA1", role: "중계", pcode: "77446", throws: "우", bats: "우" },
      // 포수 (2명)
      { id: "plr-sam-14", groupId: "team-sam", name: "강민호", nameKo: "강민호", position: "포수", jerseyNumber: 47, color: "#074CA1", role: "주전", pcode: "74540", throws: "우", bats: "우" },
      { id: "plr-sam-15", groupId: "team-sam", name: "박세혁", nameKo: "박세혁", position: "포수", jerseyNumber: 52, color: "#074CA1", role: "주전", pcode: "62244", throws: "우", bats: "우" },
      // 내야수 (8명)
      { id: "plr-sam-16", groupId: "team-sam", name: "디아즈", nameKo: "르윈 디아즈", position: "내야수", jerseyNumber: 0, color: "#074CA1", role: "4번타자", pcode: "54400", throws: "좌", bats: "좌" },
      { id: "plr-sam-17", groupId: "team-sam", name: "김영웅", nameKo: "김영웅", position: "내야수", jerseyNumber: 30, color: "#074CA1", role: "주전", pcode: "52430", throws: "우", bats: "우" },
      { id: "plr-sam-18", groupId: "team-sam", name: "류지혁", nameKo: "류지혁", position: "내야수", jerseyNumber: 16, color: "#074CA1", role: "주전", pcode: "62234", throws: "우", bats: "우" },
      { id: "plr-sam-19", groupId: "team-sam", name: "이재현", nameKo: "이재현", position: "내야수", jerseyNumber: 7, color: "#074CA1", role: "주전", pcode: "52415", throws: "우", bats: "우" },
      { id: "plr-sam-20", groupId: "team-sam", name: "전병우", nameKo: "전병우", position: "내야수", jerseyNumber: 61, color: "#074CA1", role: "주전", pcode: "65586", throws: "우", bats: "우" },
      { id: "plr-sam-21", groupId: "team-sam", name: "이해승", nameKo: "이해승", position: "내야수", jerseyNumber: 3, color: "#074CA1", role: "주전", pcode: "69416", throws: "우", bats: "우" },
      { id: "plr-sam-22", groupId: "team-sam", name: "심재훈", nameKo: "심재훈", position: "내야수", jerseyNumber: 6, color: "#074CA1", role: "주전", pcode: "55438", throws: "우", bats: "우" },
      { id: "plr-sam-23", groupId: "team-sam", name: "김재상", nameKo: "김재상", position: "내야수", jerseyNumber: 14, color: "#074CA1", role: "주전", pcode: "53400", throws: "우", bats: "우" },
      // 외야수 (7명)
      { id: "plr-sam-24", groupId: "team-sam", name: "구자욱", nameKo: "구자욱", position: "외야수", jerseyNumber: 5, color: "#074CA1", role: "핵심", pcode: "62404", throws: "우", bats: "우" },
      { id: "plr-sam-25", groupId: "team-sam", name: "최형우", nameKo: "최형우", position: "외야수", jerseyNumber: 34, color: "#074CA1", role: "핵심", pcode: "72443", throws: "우", bats: "우" },
      { id: "plr-sam-26", groupId: "team-sam", name: "김헌곤", nameKo: "김헌곤", position: "외야수", jerseyNumber: 32, color: "#074CA1", role: "주전", pcode: "61404", throws: "우", bats: "우" },
      { id: "plr-sam-27", groupId: "team-sam", name: "김지찬", nameKo: "김지찬", position: "외야수", jerseyNumber: 58, color: "#074CA1", role: "핵심", pcode: "50458", throws: "우", bats: "좌" },
      { id: "plr-sam-28", groupId: "team-sam", name: "김성윤", nameKo: "김성윤", position: "외야수", jerseyNumber: 39, color: "#074CA1", role: "주전", pcode: "67449", throws: "우", bats: "우" },
      { id: "plr-sam-29", groupId: "team-sam", name: "홍현빈", nameKo: "홍현빈", position: "외야수", jerseyNumber: 51, color: "#074CA1", role: "주전", pcode: "67005", throws: "우", bats: "우" },
      { id: "plr-sam-30", groupId: "team-sam", name: "박승규", nameKo: "박승규", position: "외야수", jerseyNumber: 66, color: "#074CA1", role: "리드오프", pcode: "69418", throws: "우", bats: "우" },
      // ── Hanwha Eagles ──
      { id: "plr-han-1", groupId: "team-han", name: "류현진", nameKo: "류현진", position: "투수", jerseyNumber: 99, color: "#FF6600", role: "에이스", pcode: "76715", throws: "좌", bats: "좌" },
      { id: "plr-han-2", groupId: "team-han", name: "문동주", nameKo: "문동주", position: "투수", jerseyNumber: 1, color: "#FF6600", role: "에이스급", pcode: "52701", throws: "우", bats: "우" },
      { id: "plr-han-3", groupId: "team-han", name: "엄상백", nameKo: "엄상백", position: "투수", jerseyNumber: 11, color: "#FF6600", role: "선발", pcode: "65056", throws: "우", bats: "우" },
      { id: "plr-han-4", groupId: "team-han", name: "에르난데스", nameKo: "에르난데스", position: "투수", jerseyNumber: 12, color: "#FF6600", role: "선발", pcode: "", throws: "우", bats: "우" },
      { id: "plr-han-5", groupId: "team-han", name: "왕옌청", nameKo: "왕옌청", position: "투수", jerseyNumber: 19, color: "#FF6600", role: "선발", pcode: "56719", throws: "우", bats: "우" },
      { id: "plr-han-6", groupId: "team-han", name: "화이트", nameKo: "화이트", position: "투수", jerseyNumber: 24, color: "#FF6600", role: "선발", pcode: "", throws: "우", bats: "우" },
      { id: "plr-han-7", groupId: "team-han", name: "황준서", nameKo: "황준서", position: "투수", jerseyNumber: 29, color: "#FF6600", role: "불펜", pcode: "54729", throws: "우", bats: "우" },
      { id: "plr-han-8", groupId: "team-han", name: "강재민", nameKo: "강재민", position: "투수", jerseyNumber: 55, color: "#FF6600", role: "마감", pcode: "50705", throws: "우", bats: "우" },
      { id: "plr-han-9", groupId: "team-han", name: "조동욱", nameKo: "조동욱", position: "투수", jerseyNumber: 57, color: "#FF6600", role: "불펜", pcode: "54768", throws: "우", bats: "우" },
      { id: "plr-han-10", groupId: "team-han", name: "주현상", nameKo: "주현상", position: "투수", jerseyNumber: 66, color: "#FF6600", role: "마감", pcode: "65707", throws: "우", bats: "우" },
      { id: "plr-han-11", groupId: "team-han", name: "한서구", nameKo: "한서구", position: "투수", jerseyNumber: 67, color: "#FF6600", role: "셋업", pcode: "53703", throws: "우", bats: "우" },
      { id: "plr-han-12", groupId: "team-han", name: "박준영", nameKo: "박준영", position: "투수", jerseyNumber: 96, color: "#FF6600", role: "선발", pcode: "52731", throws: "우", bats: "우" },
      { id: "plr-han-13", groupId: "team-han", name: "최재훈", nameKo: "최재훈", position: "포수", jerseyNumber: 13, color: "#FF6600", role: "주전", pcode: "78288", throws: "우", bats: "우" },
      { id: "plr-han-14", groupId: "team-han", name: "이재원", nameKo: "이재원", position: "포수", jerseyNumber: 20, color: "#FF6600", role: "백업", pcode: "76812", throws: "우", bats: "우" },
      { id: "plr-han-15", groupId: "team-han", name: "노시환", nameKo: "노시환", position: "내야수", jerseyNumber: 8, color: "#FF6600", role: "3번타자", pcode: "69737", throws: "우", bats: "우" },
      { id: "plr-han-16", groupId: "team-han", name: "강백호", nameKo: "강백호", position: "내야수", jerseyNumber: 50, color: "#FF6600", role: "4번타자", pcode: "68050", throws: "우", bats: "좌" },
      { id: "plr-han-17", groupId: "team-han", name: "채은성", nameKo: "채은성", position: "내야수", jerseyNumber: 22, color: "#FF6600", role: "핵심", pcode: "79192", throws: "우", bats: "우" },
      { id: "plr-han-18", groupId: "team-han", name: "이도윤", nameKo: "이도윤", position: "내야수", jerseyNumber: 5, color: "#FF6600", role: "리드오프", pcode: "65703", throws: "우", bats: "좌" },
      { id: "plr-han-19", groupId: "team-han", name: "하주석", nameKo: "하주석", position: "내야수", jerseyNumber: 16, color: "#FF6600", role: "주전", pcode: "62700", throws: "우", bats: "우" },
      { id: "plr-han-20", groupId: "team-han", name: "심우준", nameKo: "심우준", position: "내야수", jerseyNumber: 7, color: "#FF6600", role: "주전", pcode: "64006", throws: "우", bats: "우" },
      { id: "plr-han-21", groupId: "team-han", name: "한경빈", nameKo: "한경빈", position: "내야수", jerseyNumber: 6, color: "#FF6600", role: "주전", pcode: "52710", throws: "우", bats: "우" },
      { id: "plr-han-22", groupId: "team-han", name: "정민규", nameKo: "정민규", position: "내야수", jerseyNumber: 2, color: "#FF6600", role: "주전", pcode: "", throws: "우", bats: "우" },
      { id: "plr-han-23", groupId: "team-han", name: "손아섭", nameKo: "손아섭", position: "외야수", jerseyNumber: 31, color: "#FF6600", role: "핵심", pcode: "77532", throws: "우", bats: "좌" },
      { id: "plr-han-24", groupId: "team-han", name: "페라자", nameKo: "페라자", position: "외야수", jerseyNumber: 30, color: "#FF6600", role: "핵심", pcode: "54730", throws: "우", bats: "우" },
      { id: "plr-han-25", groupId: "team-han", name: "이진영", nameKo: "이진영", position: "외야수", jerseyNumber: 10, color: "#FF6600", role: "주전", pcode: "66657", throws: "우", bats: "우" },
      { id: "plr-han-26", groupId: "team-han", name: "임종찬", nameKo: "임종찬", position: "외야수", jerseyNumber: 9, color: "#FF6600", role: "주전", pcode: "50704", throws: "우", bats: "우" },
      { id: "plr-han-27", groupId: "team-han", name: "권광민", nameKo: "권광민", position: "외야수", jerseyNumber: 17, color: "#FF6600", role: "주전", pcode: "52769", throws: "우", bats: "우" },
      ...
      { id: "plr-kiw-6", groupId: "team-kiw", name: "김재웅", nameKo: "김재웅", position: "투수", jerseyNumber: 28, color: "#820024", role: "마감", pcode: "67391", throws: "우", bats: "우" },
      ...
      { id: "plr-kiw-9", groupId: "team-kiw", name: "최주환", nameKo: "최주환", position: "내야수", jerseyNumber: 7, color: "#820024", role: "4번타자", pcode: "76267", throws: "우", bats: "우" },
      ...
      { id: "plr-kiw-12", groupId: "team-kiw", name: "김태진", nameKo: "김태진", position: "내야수", jerseyNumber: 3, color: "#820024", role: "주전", pcode: "64984", throws: "우", bats: "우" },
      ...
      { id: "plr-kiw-14", groupId: "team-kiw", name: "이형종", nameKo: "이형종", position: "외야수", jerseyNumber: 55, color: "#820024", role: "주전", pcode: "78135", throws: "우", bats: "우" },
