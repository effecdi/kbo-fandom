...
export function seedIfEmpty(): void {
  ...
  if (listItems(STORE_KEYS.KBO_TEAMS).length === 0) {
    const teams: KboTeam[] = [
      { id: "team-lg", name: "LG Twins", nameKo: "LG 트윈스", city: "서울", stadium: "잠실야구장", fandomName: "트윈스 팬", foundedYear: 1982, followers: 0, fanartCount: 0, coverColor: "#C60C30", secondaryColor: "#000000", description: "서울을 대표하는 전통 구단, 2025년 한국시리즈 우승", mascot: "Luckii", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/LG.png" },
      { id: "team-kt", name: "KT Wiz", nameKo: "KT 위즈", city: "수원", stadium: "수원KT위즈파크", fandomName: "위즈 팬", foundedYear: 2015, followers: 0, fanartCount: 0, coverColor: "#000000", secondaryColor: "#ED1C24", description: "수원의 젊은 구단, 2021년 한국시리즈 우승", mascot: "Vic", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/KT.png" },
      { id: "team-ssg", name: "SSG Landers", nameKo: "SSG 랜더스", city: "인천", stadium: "인천SSG랜더스필드", fandomName: "랜더스 팬", foundedYear: 2000, followers: 0, fanartCount: 0, coverColor: "#CE0E2D", secondaryColor: "#000000", description: "인천의 자존심, 2024 리브랜딩 (Todd Radom)", mascot: "Landro", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/SK.png" },
      { id: "team-nc", name: "NC Dinos", nameKo: "NC 다이노스", city: "창원", stadium: "창원NC파크", fandomName: "다이노스 팬", foundedYear: 2013, followers: 0, fanartCount: 0, coverColor: "#315288", secondaryColor: "#C0A882", description: "창원의 공룡 군단, 2020년 한국시리즈 우승", mascot: "Dandi", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/NC.png" },
      { id: "team-doo", name: "Doosan Bears", nameKo: "두산 베어스", city: "서울", stadium: "잠실야구장", fandomName: "베어스 팬", foundedYear: 1982, followers: 0, fanartCount: 0, coverColor: "#131230", secondaryColor: "#ED1C24", description: "잠실의 전통 강호, 2025 RARE Design 리브랜딩", mascot: "Cheol-woong", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/OB.png" },
      { id: "team-kia", name: "KIA Tigers", nameKo: "KIA 타이거즈", city: "광주", stadium: "광주-기아챔피언스필드", fandomName: "타이거즈 팬", foundedYear: 1982, followers: 0, fanartCount: 0, coverColor: "#EA0029", secondaryColor: "#000000", description: "호남의 왕, KBO 최다 통합 우승 구단", mascot: "Hogini", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/HT.png" },
      { id: "team-lot", name: "Lotte Giants", nameKo: "롯데 자이언츠", city: "부산", stadium: "사직야구장", fandomName: "자이언츠 팬", foundedYear: 1982, followers: 0, fanartCount: 0, coverColor: "#041E42", secondaryColor: "#E30613", description: "부산의 영웅, 2023 갈매기 CI 리뉴얼", mascot: "Giant", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/LT.png" },
      { id: "team-sam", name: "Samsung Lions", nameKo: "삼성 라이온즈", city: "대구", stadium: "대구삼성라이온즈파크", fandomName: "라이온즈 팬", foundedYear: 1982, followers: 0, fanartCount: 0, coverColor: "#074CA1", secondaryColor: "#FFFFFF", description: "대구의 사자, 4연패 신화의 주인공", mascot: "Blazey", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/SS.png" },
      { id: "team-han", name: "Hanwha Eagles", nameKo: "한화 이글스", city: "대전", stadium: "한화생명볼파크", fandomName: "이글스 팬", foundedYear: 1986, followers: 0, fanartCount: 0, coverColor: "#FF6600", secondaryColor: "#1B2A4A", description: "대전의 독수리, 2025 새 BI 'RIDE THE STORM'", mascot: "Suri", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/HH.png" },
      { id: "team-kiw", name: "Kiwoom Heroes", nameKo: "키움 히어로즈", city: "서울", stadium: "고척스카이돔", fandomName: "히어로즈 팬", foundedYear: 2008, followers: 0, fanartCount: 0, coverColor: "#820024", secondaryColor: "#000000", description: "고척의 영웅들, 국내 유일 돔구장 구단", mascot: "Tuki", logoUrl: "https://sports-phinf.pstatic.net/team/kbo/default/WO.png" },
    ];
  ...
  if (listItems(STORE_KEYS.KBO_PLAYERS).length === 0) {
    const players: KboPlayer[] = [
      ...
      // ── Samsung Lions ──
      { id: "plr-sam-1", groupId: "team-sam", name: "구자욱", nameKo: "구자욱", position: "외야수", jerseyNumber: 51, color: "#074CA1", role: "핵심", pcode: "62404" },
      { id: "plr-sam-2", groupId: "team-sam", name: "후라도", nameKo: "후라도", position: "투수", jerseyNumber: 43, color: "#074CA1", role: "에이스", pcode: "53375" },
      { id: "plr-sam-3", groupId: "team-sam", name: "최원태", nameKo: "최원태", position: "투수", jerseyNumber: 11, color: "#074CA1", role: "마감", pcode: "65320" },
      { id: "plr-sam-4", groupId: "team-sam", name: "김영웅", nameKo: "김영웅", position: "내야수", jerseyNumber: 38, color: "#074CA1", role: "4번타자", pcode: "52430" },
      { id: "plr-sam-5", groupId: "team-sam", name: "최형우", nameKo: "최형우", position: "외야수", jerseyNumber: 34, color: "#074CA1", role: "핵심", pcode: "72443" },
      { id: "plr-sam-6", groupId: "team-sam", name: "디아즈", nameKo: "르윈 디아즈", position: "내야수", jerseyNumber: 3, color: "#074CA1", role: "3번타자", pcode: "54400" },
      { id: "plr-sam-7", groupId: "team-sam", name: "강민호", nameKo: "강민호", position: "포수", jerseyNumber: 15, color: "#074CA1", role: "주전", pcode: "74540" },
      { id: "plr-sam-8", groupId: "team-sam", name: "미야지", nameKo: "미야지", position: "투수", jerseyNumber: 47, color: "#074CA1", role: "선발", pcode: "56415" },
      { id: "plr-sam-9", groupId: "team-sam", name: "오러클린", nameKo: "오러클린", position: "투수", jerseyNumber: 55, color: "#074CA1", role: "선발", pcode: "56464" },
      { id: "plr-sam-10", groupId: "team-sam", name: "이승현", nameKo: "이승현", position: "투수", jerseyNumber: 18, color: "#074CA1", role: "선발", pcode: "51454" },
      { id: "plr-sam-11", groupId: "team-sam", name: "배찬승", nameKo: "배찬승", position: "투수", jerseyNumber: 28, color: "#074CA1", role: "셋업", pcode: "55455" },
      { id: "plr-sam-12", groupId: "team-sam", name: "김지찬", nameKo: "김지찬", position: "외야수", jerseyNumber: 1, color: "#074CA1", role: "리드오프", pcode: "50458" },
      { id: "plr-sam-13", groupId: "team-sam", name: "김헌곤", nameKo: "김헌곤", position: "외야수", jerseyNumber: 23, color: "#074CA1", role: "주전", pcode: "61404" },
      { id: "plr-sam-14", groupId: "team-sam", name: "류지혁", nameKo: "류지혁", position: "내야수", jerseyNumber: 7, color: "#074CA1", role: "주전", pcode: "62234" },
      { id: "plr-sam-15", groupId: "team-sam", name: "이재현", nameKo: "이재현", position: "내야수", jerseyNumber: 46, color: "#074CA1", role: "주전", pcode: "52415" },
      // ── Hanwha Eagles ──
