  ...
  return (
    <DashboardLayout userType="creator">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Current Plan Card */}
        <div className={`rounded-3xl border-2 p-8 mb-8 ${
          theme === "dark"
            ? "bg-gradient-to-br from-[#00e5cc]/10 to-[#00b3a6]/5 border-[#00e5cc]/30"
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Button className={`font-semibold ${
                theme === "dark"
                  ? "bg-[#00e5cc] text-black hover:bg-[#00f0ff]"
                  : "bg-gradient-to-r from-[#00e5cc] to-[#00b3a6] text-white hover:shadow-lg"
              }`}>
                플랜 업그레이드
              </Button>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className={theme === "dark" ? "text-gray-400 hover:text-white hover:bg-gray-800" : ""}
                    >
