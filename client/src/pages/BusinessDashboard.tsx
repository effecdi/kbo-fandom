    ...
    <DashboardLayout userType="business">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="rounded-2xl p-6 border hover:shadow-lg transition-shadow bg-card border-border">
          ...
          <p className="text-xs mt-1 text-muted-foreground">승인됨 3 · 검토중 2</p>
        </div>
        ...
        <div className="rounded-2xl p-6 border hover:shadow-lg transition-shadow bg-card border-border">
          ...
          <p className="text-xs mt-1 text-muted-foreground">내부 검토 필요</p>
        </div>
        ...
        <div className="rounded-2xl p-6 border hover:shadow-lg transition-shadow bg-card border-border">
          ...
          <p className="text-xs mt-1 text-muted-foreground">활발히 진행 중</p>
        </div>
        ...
        <div className="rounded-2xl p-6 border hover:shadow-lg transition-shadow bg-card border-border">
          ...
          <p className="text-xs mt-1 text-muted-foreground">협업 검토 중</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="rounded-2xl p-6 border bg-card border-border">
            <h2 className="text-xl font-black mb-6 text-foreground">
              빠른 시작
            </h2>
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                >
                  ...
                  <p className="text-sm font-semibold mt-2 text-center text-foreground">
                    {asset.name}
                  </p>
          ...
          <div className="rounded-2xl p-6 border bg-card border-border">
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  <div className="w-16 h-16 rounded-lg flex items-center justify-center bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/50 dark:to-indigo-900/50">
          ...
          <div className="rounded-2xl p-6 border bg-card border-border">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="p-4 rounded-xl transition-all cursor-pointer bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-900/20 dark:hover:bg-indigo-900/30"
                >
          ...
          <div className="rounded-2xl p-6 border bg-card border-border">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-black text-blue-600 dark:text-blue-400">90%</span>
              </div>
