    ...
    <DashboardLayout userType="business">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200 mb-8">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex items-center gap-3">
              <button className="flex items-center gap-2 px-4 py-3 bg-gray-100 rounded-xl hover:bg-gray-200 transition-all">
              ...
              <div className="border-l border-gray-200 pl-3 flex gap-2">
                <button
                  ...
                  >
                    ...
                    <div className="p-6">
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          <p className="text-xs text-gray-500 mb-1">타겟층</p>
        ...
        {compareList.length > 0 && (
          <div className="fixed bottom-8 left-1/2 -translate-x-1/2 bg-white rounded-2xl shadow-2xl border border-gray-200 p-4 flex items-center gap-4 z-50">
