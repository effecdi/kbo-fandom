        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-card rounded-2xl p-6 border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link href="/create">
                <button className="w-full p-6 bg-primary/5 rounded-xl hover:shadow-lg transition-all text-left border-2 border-transparent hover:border-primary/30">
              ...
              <button className="p-6 bg-primary/5 rounded-xl hover:shadow-lg transition-all text-left border-2 border-transparent hover:border-primary/30">
                <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center mb-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={index} className="relative group cursor-pointer">
                  <div className="aspect-square bg-primary/10 rounded-xl flex items-center justify-center group-hover:shadow-lg transition-all">
          ...
          <div className="bg-card rounded-2xl p-6 border">
            ...
            <div className="space-y-4">
              {[
                { title: "신제품 런칭 캠페인", status: "진행 중", creators: 3, date: "2025.03.31", color: "primary" },
          ...
          <div className="bg-card rounded-2xl p-6 border">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="p-4 bg-primary/5 rounded-xl hover:bg-primary/10 transition-all cursor-pointer">
          ...
          <div className="bg-card rounded-2xl p-6 border">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-black text-primary">90%</span>
              </div>
