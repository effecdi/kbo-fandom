      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <h2 className="font-black text-gray-900 mb-6">요청 내용</h2>
              <div className="space-y-4">
                <div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <h2 className="font-black text-gray-900 mb-6">첨부 파일</h2>
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center">
                <Upload className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                <p className="text-gray-600 mb-2">파일을 드래그하거나 클릭하여 업로드</p>
                <p className="text-sm text-gray-500">브랜드 가이드, 참고 자료 등</p>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 border border-gray-200 sticky top-8">
              <h3 className="font-black text-gray-900 mb-4">선택한 작가</h3>
              <div className="mb-6">
                <div className="w-20 h-20 bg-gradient-to-br from-purple-100 to-pink-100 rounded-full mx-auto mb-3" />
                <p className="font-bold text-center text-gray-900">작가 A</p>
                <p className="text-sm text-center text-gray-600">팔로워 15K</p>
              </div>

              <div className="space-y-3 mb-6">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">장르</span>
                  <span className="font-semibold text-gray-900">일상, 로맨스</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">매칭도</span>
