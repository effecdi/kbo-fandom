...
export function BusinessPage() {
  return (
    <div className="min-h-screen w-full bg-card">
      ...
      <nav className="fixed top-0 w-full bg-card/95 backdrop-blur-sm shadow-sm z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-muted-foreground hover:text-indigo-600 font-semibold">
              기능
            </a>
            <a href="#how-it-works" className="text-muted-foreground hover:text-indigo-600 font-semibold">
              활용방법
            </a>
            <a href="#pricing" className="text-muted-foreground hover:text-indigo-600 font-semibold">
              요금제
            </a>
            <Link to="/login/business" className="text-muted-foreground hover:text-indigo-600 font-semibold">
              로그인
            </Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative bg-card rounded-3xl shadow-2xl p-6">
                {/* Mock Dashboard */}
                <div className="space-y-4">
                  {/* Header */}
                  <div className="flex items-center justify-between pb-4 border-b">
                    <h3 className="font-bold text-foreground">추천 작가</h3>
                  ...
                  {[1, 2, 3].map((item) => (
                    ...
                    >
                      <div className="w-16 h-16 flex items-center justify-center bg-card rounded-xl">
                        <img
                          src={olliMascot}
                          alt={`Creator ${item}`}
                      ...
                      <div className="flex-1">
                        <p className="font-bold text-foreground">작가 {item}</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div
                key={idx}
                className="bg-card rounded-3xl p-8 hover:shadow-2xl transition-all"
              >
                <div
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-indigo-600 hover:bg-muted text-xl px-12 py-8 shadow-2xl"
            >
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-muted-foreground py-12 px-6">
        <div className="max-w-7xl mx-auto">
